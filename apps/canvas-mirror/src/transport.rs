...
use canvas_mirror_host::{generate_room_qr_svg, handle_viewer_socket, RoomQrSvgError};
use serde::Deserialize;
use tokio::{net::TcpListener, sync::oneshot, task::JoinHandle};
const DEFAULT_VIEWER_HTML: &str = include_str!("../../canvas-mirror-viewer/index.html");
